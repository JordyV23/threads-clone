<template>
  ...
  >
    <div class="bg-black h-full w-full text-white overflow-auto">
      ...
      >
        <button @click="onCancelCreation()" class="rounded-full px-2">
...
/**
 * Funcion de evento on change para el input file
 * @returns void
 */
const onChange = () => {
...
/**
 * Funcion que se ejecuta al cancelar
 */
